public class HeronsFormula //  HeronsFormula it is a module 
 {
     ...
     public static double triangleArea( int a, int b, int c )   // triangleArea is a function and a,b,c are parameter
    //  if we use void here it won't return any values 
     {
